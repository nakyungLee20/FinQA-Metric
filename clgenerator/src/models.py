...
# from transformers.models.bert import BertModel, BertEmbedding, BertEncoder
import os
...
class EncoderBert(nn.Module):
    ...
    def visualize_data(self, input_ids, attention_mask=None):
        em_output = self.bert_model(input_ids=input_ids, attention_mask=attention_mask, output_hidden_states=True, return_dict=True)
        tsne = em_output['hidden_states']
        return tsne
