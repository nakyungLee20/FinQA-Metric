...
def main():
    ...
    data2 = json.load(open("../../../dataset/mcl_data/MathQA_mbert_token_train.json"))["pairs"]
...
def sample(path, sample_num, add_nopair=False, neg_samp=False, contra_sub_tree_pos=False, neg_samp_func=RetTrue):
    ...
    if contra_sub_tree_pos:
        json.dump({"pairs": new_pairs, "pos": pair_pos}, open(".../../../dataset/pairs/FinQA-MathQA-sample.json", "w"),
                  indent=4)
    else:
